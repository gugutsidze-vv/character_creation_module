...
def attack(char_name: str, char_class: str) -> str:
    """Рассчет суммы урона наносимым персонажем."""
...
def defence(char_name: str, char_class: str) -> str:
    """Рассчет суммы блокировки урона персонажу."""
    if char_class == 'warrior':
    ...
    return (f'{char_name} принял весь урон')


def special(char_name: str, char_class: str) -> str:
    """Расчет бонуса для типа персонажа."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Функция выбора персонажа пользователем."""
    approve_choice: str = ''
    char_class: str = ''
